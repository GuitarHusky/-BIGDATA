		...
		<div class="header_big">
			...
			<ul>
				<router-link to="/index" tag='li'>
					<li style="border-bottom: 5px solid rgb(79,227,193);">概况</li>
				</router-link>
    ...
    data (){
      return {
         ...
         /* nav_list: [
          ...
          asideNav_list:[
            {to:'/p/trend',name:'1-1',text:'整体趋势'},
            {to:'/p/download',name:'1-2',text:'下载量'},
            {to:'/p/download-analyse',name:'1-3',text:'下载量分析'},
            {to:'/p/user-sign-analyse',name:'1-4',text:'用户签到分析'}
          ]
      }
    },
    components: {
