		...
		<div class="trend-top">
			<div class="basic_indicators">
				...
				<Dropdown style="margin-right: 20px;float: right;" trigger="click">
					...
					<router-link to="/todaydownload" tag='div'>
            <DropdownItem>今日下载量</DropdownItem>
          </router-link>
					<router-link to="/yesdownload" tag='div'>
							<DropdownItem>昨日下载量</DropdownItem>
					</router-link>
          <router-link to="/todayregist" tag='div'>
						<DropdownItem>今日注册量</DropdownItem>
          </router-link>
          <router-link to="/yesregist" tag='div'>
						<DropdownItem>昨日注册量</DropdownItem>
          </router-link>
          <router-link to="/yessign" tag='div'>
						<DropdownItem>昨日签到人数</DropdownItem>
          </router-link>
          <router-link to="/yesshare" tag='div'>
						<DropdownItem>昨日分享人数</DropdownItem>
          </router-link>
          <router-link to="/yesegg" tag='div'>
						<DropdownItem>昨日鸡蛋报价人数</DropdownItem>
          </router-link>
          <router-link to="/yesmaterial" tag='div'>
						<DropdownItem>昨日原料报价人数</DropdownItem>
          </router-link>
          <router-link to="/yesread" tag='div'>
						<DropdownItem>昨日阅读文章数</DropdownItem>
          </router-link>
          <router-link to="/yesuserpv" tag='div'>
						<DropdownItem>昨日活跃用户(PV)</DropdownItem>
          </router-link>
          <router-link to="/yesuseruv" tag='div'>
...
<script>
	import { downloadList, registerList, signShareList, telSearchEggPrice, readAndActiveList, dayNewRegist, telSearchRegist, getTodayActiveUser } from '../../api/api'
	export default {
		methods: {
			draWbatter() {
        ...
        telSearchEggPrice({
          ...
          this.$Spin.hide();
          this.total_egg = res.data.list.count;
        })
        telSearchEggPrice({
          tel: '',
          type: 7,
          ...
          this.$Spin.hide();
          this.yes_egg = res.data.list.count;
        })
        telSearchEggPrice({
          tel: '',
          type: 8,
          ...
          this.$Spin.hide();
          this.total_material = res.data.list.count;
        })
        telSearchEggPrice({
          tel: '',
          type: 9,
          ...
          this.$Spin.hide();
          this.yes_material = res.data.list.count;
        })
				/*telSearchEggPrice().then(res => {
					this.$Spin.hide();
