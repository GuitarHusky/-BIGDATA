  ...
  <div class="total-info pad">
    ...
    <Row>
      ...
      <router-link tag='div' to='/modaluser/collectinfo'>
        ...
        <div v-else>
          <span style="color: rgb(56, 153, 254);">收藏次数</span></br>
          <span class='date-num' style="color: rgb(56, 153, 254);">{{collectNum}}</span></br>
        </div>
        </Col>
      </router-link>
    </Row>
    <Row style="margin-top:20px;">
      ...
      <div class="table-title tableStyle">
        <span style="font-size:16px;">收藏次数详细</span>
...
<script>
  import { getCollectNumData,getManagerMallData } from '../../../api/api'
  export default {
    data(){
      return {
        user_total: true,
    ...
    methods: {
      ...
      dateLink(currentRow, oldCurrentRow){
        this.$router.push('/modaluser/collectdateinfo/' + currentRow.date_time)
      },
      getData(){
