<template>
  <div class="total-info pad">
    <Row>
      <Col span="24" class="table-title tableStyle">精华帖详细
      ...
      <Button type="primary" @click="searchGoodForumData">搜索</Button>
...
<script>
  import { getGoodForumTotalData } from '../../../api/api'
  export default {
    data() {
      return {
        // 初始化信息总条数
