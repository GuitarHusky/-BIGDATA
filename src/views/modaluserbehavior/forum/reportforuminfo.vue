<template>
  <div class="total-info pad">
    <Row>
      <Col span="24" class="table-title tableStyle">被举报帖详细
      ...
      <Button type="primary" @click="searchReportForumData">搜索</Button>
...
<script>
  import { getReportedForumTotalData } from '../../../api/api'
  export default {
    data() {
      return {
        // 初始化信息总条数
