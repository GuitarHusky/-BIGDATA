<template>
  <div class="pad">
    ...
    <Row>
      <router-link tag='div' to='/modaluser/viewlittlevideototaldetail'>
      ...
      <router-link tag='div' to='/modaluser/littlevideototalscoredetail'>
        <Col class="trend-col" span="6">
        <div style="font-size: 16px;" v-if='user_total'>
          加载中...
        </div>
      ...
      <router-link tag='div' to='/modaluser/littlevideocounttotalcollect'>
        <Col class="trend-col" span="6">
        <div style="font-size: 16px;" v-if='user_total'>
          加载中...
        </div>
      ...
      <router-link tag='div' to='/modaluser/littlevideocountmessagedetail'>
        <Col class="trend-col" span="6">
        <div style="font-size: 16px;" v-if='user_total'>
          加载中...
        </div>
    ...
    methods: {
      ...
      draWdayvideocollect() {
        ...
        myChart.on('click', function(pa) {
          ...
          _this.$router.push('/modaluser/littledaycollectvideoinfo/' + pa.name)
        })
        myChart.setOption({
          color: colors,
          tooltip: {
