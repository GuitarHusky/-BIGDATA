	...
	<div class="total-info pad">
		<!-- <div class="crumbs_me">
			<Breadcrumb separator=">">
				...
				<BreadcrumbItem>论坛发帖次数 </BreadcrumbItem>
			</Breadcrumb>
		</div> -->
		<Row>
			<Col span="24" class="table-title tableStyle"> 论坛发帖次数
...
<script>
	import { getUserSign, getCommunityInfo } from '../../../api/api'
	export default {
		data() {
			return {
				// 初始化信息总条数
      ...
      goBack(){
        ...
        this.endtime = end.getFullYear() + '-' + (end.getMonth() + 1) + '-' + end.getDate()
				...
				getCommunityInfo({
					...
					this.$Spin.hide();
					this.dataCount = res.data.communityInfo.count;
					this.historyData = res.data.communityInfo.list
					var num = 1
