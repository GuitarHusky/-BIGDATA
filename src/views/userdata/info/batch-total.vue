<template>
	<div class="total-info pad">
      ...
      <Breadcrumb separator=">">
        ...
        <BreadcrumbItem >建立栋舍数</BreadcrumbItem>
      </Breadcrumb>
    </div> -->
		<Row>
			<Col span="24" class="table-title tableStyle"> 建立栋舍数
      ...
      <DatePicker type="daterange" :options="options2" placement="bottom-start" v-model="timeInput" confirm format="yyyy-MM-dd"  style="width: 200px;font-size:14px;margin-left:30px;"></DatePicker>
			<RadioGroup v-model="disabledGroup">
				<Radio label="2">旧版栋舍</Radio>
				<Radio label="1">新版栋舍</Radio>
			</RadioGroup>
...
<script>
	import { getBatchInfo } from '../../../api/api'
	export default {
		data() {
			return {
				// 初始化信息总条数
      ...
      goBack(){
        ...
        this.endtime = end.getFullYear() + '-' + (end.getMonth() + 1) + '-' + end.getDate()
				...
				getBatchInfo({
					...
					this.$Spin.hide();
					this.dataCount = res.data.BatchInfo.count;
